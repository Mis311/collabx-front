...
export default function CreateProject() {
  ...
  const handleSubmit = () => {
    ...
    // For pure React, you could use history.push (from react-router-dom) if you're handling routing
    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <div className="p-8 mx-auto  bg-gray-900 shadow-lg rounded-lg overflow-hidden">
        ...
        <div className="p-8 bg-gray-900 text-white">
          <h2 className="text-xl font-semibold mb-4">Make Your Collab X Card (Initial contributors/support you need)</h2>
          <p className="text-sm text-gray-400 mb-4">Choose those talent who can scale up your contents to next level.</p>
